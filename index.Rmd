...
This test is a non-parametric test, which means that it does not require as many assumptions as some parametric tests, like the linear regression. It also provides us with different information than a linera regression.

According to [this report](https://www.statisticshowto.com/wp-content/uploads/2016/08/Mann-Kendall-Analysis-1.pdf), the Mann-Kendall $S$ is calculated as follows:
