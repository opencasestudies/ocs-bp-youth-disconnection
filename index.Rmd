...
#### {.scrollable }
```{r}
pdf_data_example <- pdftools::pdf_data(here("Making_the_Connection.pdf"))

utils::head(pdf_data_example, 1)

pdf_tools_example <- pdftools::pdf_text(here("Making_the_Connection.pdf"))
...
image_example <- magick::image_read(here::here("gender_race_ethnicity.png"))
...
```{r, dpi = 1000}
#bold is causing issues
image1 <- image_read(here("gender_race_ethnicity2.png"))
...
```{r}
image2 <- image_read(here("asian_subgroups.png"))
image2
```
...
```{r}
image2a <- image_read(here("asian_subgroupsA.png"))
image2b <- image_read(here("asian_subgroupsB.png"))
image2c <- image_read(here("asian_subgroupsC.png"))
...
```{r}
image5 <- image_read(here("asian_subgroups_2018.png"))
...
```{r}
excerpt <- image_read(here("asian_youth_excerpt.png"))
...
```{r}
image3 <- image_read(here("latino_a_subgroups.png"))
```
...
```{r}
image5 <- image_read(here("latino_a_subgroups_2018.png"))
...
```{r}
rm(excerpt)
excerpt <- image_read(here("latino_a_youth_excerpt.png"))
...
```{r, eval=FALSE}
quadrant1 <- image_read(here("state_quadrant1.png"))
quadrant2 <- image_read(here("state_quadrant2.png"))
quadrant3 <- image_read(here("state_quadrant3.png"))
quadrant4 <- image_read(here("state_quadrant4.png"))
...
include_graphics("Making_the_Connection_plot.png")
```
