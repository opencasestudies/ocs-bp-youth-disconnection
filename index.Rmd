...
```{r}
asian_subgroups <- image_read(here::here("data", "raw", "asian_subgroups_2017.png"))
```
...
You can download the next image files to follow along [here](https://raw.githubusercontent.com/opencasestudies/ocs-bp-youth-disconnection/master/data/raw/asian_sub_A.png) and [here](https://raw.githubusercontent.com/opencasestudies/ocs-bp-youth-disconnection/master/data/raw/asian_sub_B.png) and [here](https://raw.githubusercontent.com/opencasestudies/ocs-bp-youth-disconnection/master/data/raw/asian_sub_C.png).

```{r, out.width= "40%"}
asian_sub_A <- image_read(here("data", "raw", "asian_sub_A.png"))
asian_sub_B <- image_read(here("data", "raw", "asian_sub_B.png"))
asian_sub_C <- image_read(here("data", "raw", "asian_sub_C.png"))
...
The names of the files for the screenshots are `latinx_sub_A.png`, `"latinx_sub_B.png`, and `"latinx_sub_C.png"`. They are located in the "raw" subdirectory of the "data" directory in our GitHub repository.

You can download the next image files to follow along [here](https://raw.githubusercontent.com/opencasestudies/ocs-bp-youth-disconnection/master/data/raw/latinx_sub_A.png) and [here](https://raw.githubusercontent.com/opencasestudies/ocs-bp-youth-disconnection/master/data/raw/latinx_sub_B.png) and [here](https://raw.githubusercontent.com/opencasestudies/ocs-bp-youth-disconnection/master/data/raw/latinx_sub_C.png).
...
```{r}
latinx_imageA <- image_read(here::here("data", "raw", "latinx_sub_A.png"))
latinx_imageB <- image_read(here::here("data", "raw", "latinx_sub_B.png"))
latinx_imageC <- image_read(here::here("data", "raw", "latinx_sub_C.png"))
...
write_file(asian_subgroups, file = here::here("data", "simpler_import", "asian_subgroups.csv"))
write_file(asian_sub_A, file = here::here("data", "simpler_import", "asian_sub_A.csv"))
write_file(asian_sub_B, file = here::here("data", "simpler_import", "asian_sub_B.csv"))
write_file(asian_sub_C, file = here::here("data", "simpler_import", "asian_sub_C.csv"))
write_file(latinx_A, file = here::here("data", "simpler_import", "latinx_A.csv"))
write_file(latinx_B, file = here::here("data", "simpler_import", "latinx_B.csv"))
write_file(latinx_C, file = here::here("data", "simpler_import", "latinx_C.csv"))
...
An RDA file (stands for R data) of the data can be found [here](https://github.com//opencasestudies/ocs-bp-youth_disconnection/tree/master/data/imported) or slightly more directly [here](https://raw.githubusercontent.com/opencasestudies/ocs-bp-youth_disconnections/master/data/imported/imported_data.rda). Download this file and then place it in your current working directory within a subdirectory called "imported" within a subdirectory called "data" to copy and paste our code. We used an RStudio project and the [`here` package](https://github.com/jennybc/here_here) to navigate to the file more easily. 
...
These images are called `asian_sub_A`, `asian_sub_B`, and `asian_sub_C`.
...
An RDA file (stands for R data) of the data can be found [here](https://github.com//opencasestudies/ocs-bp-youth_disconnection/tree/master/data/wrangled) or slightly more directly [here](https://raw.githubusercontent.com/opencasestudies/ocs-bp-youth_disconnections/master/data/wrangled/wrangled_data.rda). Download this file and then place it in your current working directory within a subdirectory called "wrangled" within a subdirectory called "data" to copy and paste our code. We used an RStudio project and the [`here` package](https://github.com/jennybc/here_here) to navigate to the file more easily. 
