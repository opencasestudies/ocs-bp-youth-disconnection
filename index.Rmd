...
AVOCADO: Ok, I wanted to "soak" in the main figure and spent some time reading through it before diving into the case study. I still haven't dived into the case yet (that's next), but my initial impression is that there is way way too much going on in this main figure. It took me like a good 5 mins to understand. I think we should talk about removing portions of it and simplying it. My current suggestion is to remove all the bar plots and only have the line plots at the top. 
