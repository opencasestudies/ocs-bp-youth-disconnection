...
We can combine these two tibbles using the `bind_rows()` function of `dplyr`. We can use the `glimpse()` function to get
...
How to add space betwen barplots
https://stackoverflow.com/questions/51502797/how-to-add-space-between-groups-of-bars-in-barplot-ggplot
